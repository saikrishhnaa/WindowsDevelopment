...
public:
	...
	// IClassFactory method declarations (inherited)
...
{
	// Intialization of private data members
...
// Implementation Of CSumSubstract's IUnknown's Methods
...
HRESULT CSumSubtractClassFactory::CreateInstance(IUnknown *pUnkOuter, REFIID riid, void **ppv)
{
	...
	pCSumSubtract->QueryInterface(riid, ppv);
